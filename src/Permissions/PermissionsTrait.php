...
trait PermissionsTrait
{
     ...
     * @return void
     */
    public function __construct($permissions = null, $secondaryPermissions = null)
    {
     ...
     * @return $this
     */
    public function setSecondaryPermissions($secondaryPermissions)
    {
        $this->secondaryPermissions = $secondaryPermissions;
     ...
     * @return void
     */
    protected function preparePermissions(&$prepared, $permissions)
    {
     ...
     * @return bool
     */
    protected function checkPermission($prepared, $permission)
    {
