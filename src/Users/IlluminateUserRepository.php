...
use Walruship\Laratrust\Hashing\HasherInterface;
...
class IlluminateUserRepository implements UserRepositoryInterface
{
     ...
     * The Hasher instance.
     *
     * @var \Walruship\Laratrust\Hashing\HasherInterface
     */
    protected $hasher;
     ...
     * Constructor.
     *
     * @param \Walruship\Laratrust\Hashing\HasherInterface $hasher
    ...
    public function create(array $credentials, \Closure $callback = null): ?UserInterface
    {
        ...
        $this->fireEvent('walruship.user.creating', compact('user', 'credentials'));
        ...
        $this->fireEvent('walruship.user.created', compact('user', 'credentials'));
    ...
    public function update($user, array $credentials): UserInterface
    {
        ...
        $this->fireEvent('walruship.user.updating', compact('user', 'credentials'));

        $this->fill($user, $credentials);

        $user->save();

        $this->fireEvent('walruship.user.updated', compact('user', 'credentials'));
    ...
    {
        $this->fireEvent('walruship.user.filling', compact('user', 'credentials'));
        ...
        $this->fireEvent('walruship.user.filled', compact('user', 'credentials'));
    }

    /**
     * Returns the hasher instance.
     *
     * @return \Walruship\Laratrust\Hashing\HasherInterface
     */
